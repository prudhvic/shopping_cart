...
let promise = loadStripe(
  "pk_test_51Kto6zSJQCApE4jyDtQB9G884royTnVxBybWlLA5ZNQBDvSiSiibNVsDPXXeFhqH51q8tmCKsb2nvb7glKdB9Yrh00cbPboExl"
);

let Form = () => {
  let { cart, total_amount, shipping_fee } = useCartContext();
  let { user } = UserPorvider();
    ...
    <>
      {succeeded ? (
        ...
        <article>
          ...
          <p>Your total is {Format(total_amount)}</p>
